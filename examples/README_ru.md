---
title: Работа с файлами формата ELF из Хаскеля
...
["Минимизация файла ELF – попробуем в 2021?"](https://habr.com/ru/company/ruvds/blog/583576/),
["Создание исполняемого файла ELF вручную"](https://habr.com/ru/post/543622/),
["Эльфы в памяти. Выполнение ELF в оперативной памяти Linux"](https://habr.com/ru/company/fbk_cs/blog/430902/),
["Микрохирургия ELF'а или «А что, так можно было?!»"](https://habr.com/ru/post/536874/) и т. д.)
...
Сегменты и секции -- непрерывные участки файла.  Сегменты описывают, что нужно поместить в память при загрузки программы, а секции я бы описал как неделимые элементарные результаты работы
